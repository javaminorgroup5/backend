...
public class GroupService {
    ...
    @PostConstruct
    public void init() {
        final User initialGroup1 = new Group(1, "PastaGroep", "Leuke pasta groep", 3);
        final User initialGroup2 = new Group(2, "RodeSauzen", "Roder dan rood", 3);
        groepRepository.saveAll(Arrays.asList(initialGroup1, initialGroup2));
