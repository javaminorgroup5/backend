...
public class TestDataService {
    ...
    public List<Message> getFeeds() throws IOException {
        ...
        final Message message1 = new Message("Makkelijke en gezonde glutenvrije bananenpannenkoekjes gemaakt van banaan en ei, lekker om mee te ontbijten of als tussendoortje", 3L, 6L, "Test", image1);
        ...
        final Message message2 = new Message("Gezond bananenbrood met een heerlijke crunch van pecannoten en walnoten", 3L, 6L, "Test", image2);
        ...
        final Message message3 = new Message("Kerst ovenschotel met pompoen", 3L, 6L, "Test", image3);
